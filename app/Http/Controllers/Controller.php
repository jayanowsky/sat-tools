...
class Controller extends BaseController
{
    ...
    public function respondWentWrong($exception = null)
    {
        ...
        $message = (env('APP_DEBUG') === true) ? "File:" . $exception->getFile(). "Line:" . $exception->getLine(). "Message:" . $exception->getMessage() : 'messages.something_went_wrong';
    ...
    {
        $message = is_null($message) ? __('success') : $message;
